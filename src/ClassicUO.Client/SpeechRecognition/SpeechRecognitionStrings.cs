...
namespace ClassicUO.Game
{
    internal static class SpeechRecognitionStrings
    {
        ...
        public static readonly string[] AllFollowMeCommands = new string[]
        {
            "all follow me", "follow me", "all come with me", "come with me", "all follow", "follow"
        };

        public static readonly string[] AllStayCommands = new string[]
        {
            "all stay", "stay", "all hold position", "hold position", "all wait here", "wait here"
        };

        public static readonly string[] AllGuardMeCommands = new string[]
        {
            "all guard me", "guard me", "all protect me", "protect me", "all defend me", "defend me"
        };

        public static readonly string[] AllKillCommands = new string[]
        {
            "all kill", "kill", "all attack", "attack", "all engage", "engage"
        };

        public static readonly string[] AllStopCommands = new string[]
        {
            "all stop", "stop", "all halt", "halt", "all cease", "cease"
        };

        public static readonly string[] AllReleaseCommands = new string[]
        {
            "all release", "release", "all free", "free", "all dismiss", "dismiss"
        };

        public static readonly string[] AllComeCommands = new string[]
        {
            "all come", "come", "all here", "here", "all return", "return"
        };

        public static readonly string[] AllPatrolCommands = new string[]
        {
            "all patrol", "patrol", "all scout", "scout", "all survey", "survey"
        };

        public static readonly string[] AllFetchCommands = new string[]
        {
            "all fetch", "fetch", "all retrieve", "retrieve", "all get", "get"
        };

        public static readonly string[] AllDropCommands = new string[]
        {
            "all drop", "drop", "all release items", "release items", "all unload", "unload"
        };

        public static readonly string[] AllFollowTargetCommands = new string[]
        {
            "all follow [target]", "follow [target]", "all tail [target]", "tail [target]", "all shadow [target]", "shadow [target]"
        };

        public static readonly string[] AllAttackTargetCommands = new string[]
        {
            "all attack [target]", "attack [target]", "all engage [target]", "engage [target]", "all strike [target]", "strike [target]"
        };

        public static readonly string[] AllTransferCommands = new string[]
        {
            "all transfer", "transfer", "all hand over", "hand over", "all give control", "give control"
        };

        public static readonly string[] AllFriendCommands = new string[]
        {
            "all friend", "friend", "all befriend", "befriend", "all add friend", "add friend"
        };

        public static readonly string[] AllUnfriendCommands = new string[]
        {
            "all unfriend", "unfriend", "all remove friend", "remove friend", "all defriend", "defriend"
        };

        public static readonly string[] AllKillClosestCommands = new string[]
        {
            "all kill closest", "kill closest", "all attack nearest", "attack nearest", "all engage closest", "engage closest", "all strike nearest", "strike nearest"
        };
